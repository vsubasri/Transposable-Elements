...
if (!exists("te_taylor_t")) {
  ...
  ggsave(paste0(plot_dir, "taylor/taylor_te_count_by_subclass_kruskal.png"), plot = p_kruskal, width = 10, height = 6)
  ...
  ggsave(paste0(plot_dir, "taylor/taylor_te_count_by_age.png"), plot = p_age, width = 8, height = 6)
