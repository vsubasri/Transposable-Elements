...
if (PROCESS_COMMON_TES) {
  ...
  ggsave(paste0(plot_dir, "general/te_count_type_all_common.pdf"), plot = p1, width = 9, height = 5)
}
...
ggsave(paste0(plot_dir, "general/te_count_type_all_rare.pdf"), plot = p2, width = 9, height = 5)
...
ggsave(paste0(plot_dir, "general/te_count_type_aff_rare.pdf"), plot = p3, width = 9, height = 5)
...
ggsave(paste0(plot_dir, "general/te_counts_unique_aff_expand.pdf"), plot = p4, width = 9, height = 5)
...
if (PROCESS_COMMON_TES) {
  ...
  ggsave(paste0(plot_dir, "general/te_type_sample_common.pdf"), plot = p5, width = 9, height = 5)
}
...
ggsave(paste0(plot_dir, "general/te_count_total_te_calls_kics.pdf"), plot = p6, width = 9, height = 5)
