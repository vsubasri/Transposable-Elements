...
PREFIX=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/test/NA12878/L1/
############
############
ANNOTATION=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/LINE/hg19/hg19_L1_larger500_with_all_L1HS.out
ANNOTATION1=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/LINE/hg19/hg19_L1.fa.out
...
BLACK_LIST=null
L1_COPY_WITH_FLANK=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/LINE/hg19/hg19_L1HS_copies_larger_5K_with_flank.fa
SF_FLANK=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/LINE/hg19/hg19_FL_L1_flanks_3k.fa
L1_CNS=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/consensus/LINE1.fa
...
python ${XTEA_PATH}"x_TEA_main.py" --transduction --cr 3 --nd 5 -b ${BAM_LIST} -p ${TMP_TNSD} --fflank ${SF_FLANK} --flklen 3000 -n 8 -i ${PREFIX}"candidate_disc_filtered_cns.txt" -r ${L1_CNS} --ref ${REF} --input2 ${PREFIX}"candidate_list_from_disc.txt.clip_sites_raw_disc.txt" --rtype 1 -a ${ANNOTATION1}    -o ${PREFIX}"candidate_disc_filtered_cns2.txt"
python ${XTEA_PATH}"x_TEA_main.py" --sibling --cr 3 --nd 5 -b ${BAM_LIST} -p ${TMP_TNSD} --fflank ${SF_FLANK} --flklen 3000 -n 8 -i ${PREFIX}"candidate_disc_filtered_cns2.txt" -r ${L1_CNS} --ref ${REF} --input2 ${PREFIX}"candidate_list_from_disc.txt.clip_sites_raw_disc.txt" --rtype 1 -a ${ANNOTATION1} --blacklist ${BLACK_LIST}    -o ${PREFIX}"candidate_sibling_transduction2.txt"
python ${XTEA_PATH}"x_TEA_main.py" --postF --rtype 1 -p ${TMP_CNS} -n 8 -i ${PREFIX}"candidate_disc_filtered_cns2.txt" -a ${ANNOTATION1}  -o ${PREFIX}"candidate_disc_filtered_cns_post_filtering.txt"
python ${XTEA_PATH}"x_TEA_main.py" --postF --rtype 1 -p ${TMP_CNS} -n 8 -i ${PREFIX}"candidate_disc_filtered_cns2.txt.high_confident" -a ${ANNOTATION1} --blacklist ${BLACK_LIST}  -o ${PREFIX}"candidate_disc_filtered_cns.txt.high_confident.post_filtering.txt"
