...
PREFIX=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/test/NA12878/SVA/
############
############
ANNOTATION=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/SVA/hg19/hg19_SVA.out
ANNOTATION1=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/SVA/hg19/hg19_SVA.out
...
BLACK_LIST=null
L1_COPY_WITH_FLANK=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/SVA/hg19/hg19_SVA_copies_with_flank.fa
SF_FLANK=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/SVA/hg19/hg19_FL_SVA_flanks_3k.fa
L1_CNS=/hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/rep_lib_annotation/consensus/SVA.fa
...
############
############
python ${XTEA_PATH}"x_TEA_main.py" -C --sva -i ${BAM_LIST} --lc 3 --rc 3 --cr 1  -r ${L1_COPY_WITH_FLANK}  -a ${ANNOTATION} --cns ${L1_CNS} --ref ${REF} -p ${TMP} -o ${PREFIX}"candidate_list_from_clip.txt"  -n 8 --cp /hpf/largeprojects/davidm/vsubasri/transposable_elements/xTea/test/NA12878/pub_clip/     
...
python ${XTEA_PATH}"x_TEA_main.py" -N --sva --cr 3 --nd 5 -b ${BAM_LIST} -p ${TMP_CNS} --fflank ${SF_FLANK} --flklen 3000 -n 8 -i ${PREFIX}"candidate_list_from_disc.txt" -r ${L1_CNS} --ref ${REF} -a ${ANNOTATION} -o ${PREFIX}"candidate_disc_filtered_cns.txt"    
python ${XTEA_PATH}"x_TEA_main.py" --transduction --cr 3 --nd 5 -b ${BAM_LIST} -p ${TMP_TNSD} --fflank ${SF_FLANK} --flklen 3000 -n 8 -i ${PREFIX}"candidate_disc_filtered_cns.txt" -r ${L1_CNS} --ref ${REF} --input2 ${PREFIX}"candidate_list_from_disc.txt.clip_sites_raw_disc.txt" --rtype 4 -a ${ANNOTATION1}    -o ${PREFIX}"candidate_disc_filtered_cns2.txt"
